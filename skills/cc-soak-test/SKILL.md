...
**When to run:**
- Polish phase — before `/cc-gate-check release`
...
5. Run `/cc-bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `/cc-smoke-check` again after fixing the issues."
