---
description: "Use when working on gameplay systems (combat, movement, abilities, progression). Covers data-driven values, frame-rate independence, event-based communication, state machines, and test requirements."
