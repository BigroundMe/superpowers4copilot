...
description: |
  ...
  Manually triggered: use @gem-critic in chat, or auto-invoked by gem-orchestrator during Plan phase for complex projects.
  Complements the brainstorming workflow — call gem-critic after brainstorming produces solution proposals to stress-test them.
  Triggers: 'critique', 'challenge', 'edge cases', 'over-engineering', 'logic gaps', 'quality check', 'is this a good idea'.
name: gem-critic
