---
description: "Use when working on UI systems (HUD, menus, dialogs, input handling). Covers display-only UI principle, localization requirements, input method support, accessibility mandates, and resolution testing."
applyTo: "src/ui/**"
---
