---
description: "Use when working on networking and multiplayer systems (replication, prediction, reconciliation, matchmaking). Covers server authority, message versioning, bandwidth budgets, and security validation."
