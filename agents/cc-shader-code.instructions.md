---
description: "Use when working on shaders and materials (visual effects, post-processing, surface shaders). Covers naming conventions, performance budgets, precision requirements, cross-platform compatibility, and variant management."
