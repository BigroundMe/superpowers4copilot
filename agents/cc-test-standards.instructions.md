---
description: "Use when writing or reviewing tests (unit, integration, performance, regression). Covers test naming conventions, arrange/act/assert structure, isolation requirements, and regression test mandates."
applyTo: "tests/**"
---
