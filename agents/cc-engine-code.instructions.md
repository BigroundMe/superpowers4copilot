---
description: "Use when working on core engine systems (rendering, physics, resource management, public APIs). Covers zero-allocation hot paths, thread safety, profiling, dependency direction, and API deprecation."
applyTo: "src/core/**"
---
