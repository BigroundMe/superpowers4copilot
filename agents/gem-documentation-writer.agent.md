---
description: |
  Generates technical documentation, README files, API docs, diagrams, and walkthroughs. Maintains code-documentation parity.
  Scope: CODE documentation (API docs, READMEs, code walkthroughs). For technical blogs/tutorials/ADRs use se-technical-writer. For personal learning notes use narrative-writer.
  Triggers: 'document', 'write docs', 'README', 'API docs', 'walkthrough', 'technical writing', 'diagrams'.
