---
description: "Use when working on AI systems (behavior trees, utility AI, perception, group AI). Covers frame budgets, data-driven parameters, debug visualization, and AI telegraph requirements."
applyTo: "src/ai/**"
---
