---
description: "Use when working on prototypes (throwaway experiments, mechanic validation, rapid iteration). Covers relaxed standards, mandatory README structure, isolation rules, and promotion-to-production workflow."
applyTo: "prototypes/**"
---
